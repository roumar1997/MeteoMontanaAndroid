...
object NetworkModule {
    ...
    @Provides @Singleton
    fun provideKtorPhotoApi(client: HttpClient) =
        com.meteomontana.android.data.api.KtorPhotoApi(client)
    ...
    @Provides @Singleton
    fun provideKtorSchoolPresenceApi(client: HttpClient) =
        com.meteomontana.android.data.api.KtorSchoolPresenceApi(client)
}
