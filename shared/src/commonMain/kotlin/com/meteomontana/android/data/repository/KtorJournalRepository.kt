...
class KtorJournalRepository(private val api: KtorJournalApi) : JournalRepository {
    ...
    override suspend fun getUserStats(uid: String): JournalStats =
        api.getUserStats(uid).toDomain()
    override suspend fun getUserJournal(uid: String): List<JournalSession> =
    ...
    override suspend fun updateJournalStyle(id: String, aVista: Boolean, alFlash: Boolean): JournalSession =
        api.updateJournalStyle(id, aVista, alFlash).toDomain()
}
